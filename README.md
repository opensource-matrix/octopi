...
## Controllers
The Controller module is incomplete, but we plan to implement templating with views and other standard tools for PHP frameworks.  To create a new controller, make a file 